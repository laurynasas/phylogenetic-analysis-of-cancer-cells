...
# import parsimony_tree_builder as pars
...
#     dir = "/home/laurynas/workspace/individual_project/simulated_data/" + sample_name + ".txt"
#
#     populated_data = k_means_instance.get_true_genotypes(dir)
...
#         rands.append(rand)
#         # print full_dict
#         predicted = pars.get_genotypes_from_clusters(full_dict, vector_size)
#
#         print "True genotypes: ", populated_data
#         print "Predicted genotypes: ", predicted
#         print "Compared genotypes correct/total_true: ", k_means_instance.compare_genotypes(populated_data, predicted)
